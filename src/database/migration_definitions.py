"""
Migration definitions for Medical Assistant database.

All Migration instance definitions are centralized here.
The Migration class itself is defined in db_migrations.py.
"""
...
def get_all_migrations() -> List[Migration]:
    """Get all database migration definitions.
