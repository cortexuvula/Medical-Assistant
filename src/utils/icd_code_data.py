...
Static dictionaries of common ICD-9 and ICD-10 diagnostic codes with descriptions.
Extracted from icd_validator.py to keep data separate from validation logic.
"""
