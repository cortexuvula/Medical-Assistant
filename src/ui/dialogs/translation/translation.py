...
class TranslationMixin:
    ...
    # Methods from other mixins (type hints only - must NOT shadow real implementations)
    # Note: _add_history_entry is defined in HistoryMixin which comes AFTER this mixin in MRO
    # Do NOT add a stub for it here or it will shadow the real implementation
